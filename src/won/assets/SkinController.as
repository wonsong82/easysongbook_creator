package won.assets
{
	...
	public class SkinController extends Button
	{
		...
		public function set isSkinSelected(bool:Boolean):void {_skinSelected = bool;}
		override public function get name() : String{return _name;}		
		override public function set name(name:String):void {_name = name;}
