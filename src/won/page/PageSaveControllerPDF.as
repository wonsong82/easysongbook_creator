package won.page
{
	...
	public class PageSaveControllerPDF extends EventDispatcher
	{
		...
		public function PageSaveControllerPDF(application:Object)
		{
			_app = application;	
			_app.saveSpeed.visible = false;		
			_app.saveSpeedLabel.visible = false;	
			_app.saveQuality.visible = false;
			_app.saveQualityLabel.visible = false;
		}
		...
		{				
			...
			_pdf.addImage(_app.page, resize , 0, 0, 0, 0);			
			
			
			
			_app.message("Added Page " + _pageNum.toString());
			saveLoadingHandler(new LoadingEvent(LoadingEvent.PROGRESS, 'Added',1, 1)); 
		...
		private function write(e:Event=null):void
		{
			...
			var pdfFile:File = _saveFolder.resolvePath(pdfFileName);
